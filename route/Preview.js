amis.define('route/Preview.tsx', function(require, exports, module, define) {
  ...
  var NotFound_1 = (0, tslib_1.__importDefault)(require("route/NotFound.tsx"));
  var AMISRenderer_1 = (0, tslib_1.__importDefault)(require("component/AMISRenderer.tsx"));
  var AddPageModal_1 = (0, tslib_1.__importDefault)(require("component/AddPageModal.tsx"));
  ...
  exports.default = (0, mobx_react_1.inject)('store')((0, mobx_react_1.observer)(function (_a) {
      ...
      function renderAside() {
          ...
          return (react_1.default.createElement(amis_1.AsideNav, { key: store.asideFolded ? 'folded-aside' : 'aside', navigations: [
                  ...
                  return link.path ? (link.active ? (react_1.default.createElement("a", null, children)) : (react_1.default.createElement(react_router_dom_1.Link, { to: link.path[0] === '/' ? link.path : "".concat(link.path) }, children))) : (react_1.default.createElement("a", { onClick: link.onClick ? link.onClick : link.children ? function () { return toggleExpand(link); } : undefined }, children));
              }, isActive: function (link) {
                  return isActive(link.path && link.path[0] === '/' ? link.path : "".concat(link.path), location);
              } }));
      }
      function handleConfirm(value) {
          store.addPage((0, tslib_1.__assign)((0, tslib_1.__assign)({}, value), { schema: {
                  type: 'page',
                  title: value.label,
                  body: '这是你刚刚新增的页面。'
              } }));
