amis.define('route/Editor.tsx', function(require, exports, module, define) {
  ...
  var schemaUrl = "".concat(host, "/schema.json");
  // @ts-ignore
  '/schema.json';
  exports.default = (0, mobx_react_1.inject)('store')((0, mobx_react_1.observer)(function (_a) {
      ...
      function exit() {
          history.push("/".concat(store.pages[index].path));
      }
      function renderHeader() {
          return (react_1.default.createElement("div", { className: "editor-header clearfix box-shadow bg-dark" },
              ...
              react_1.default.createElement("div", { className: "editor-header-btns" },
                  react_1.default.createElement("div", { className: (0, amis_1.classnames)('btn-item'), onClick: save }, "\u4FDD\u5B58"),
      ...
      return (react_1.default.createElement(amis_1.Layout, { header: renderHeader(), headerFixed: false },
          react_1.default.createElement(amis_editor_1.Editor, { theme: 'cxd', preview: store.preview, value: store.schema, onChange: function (value) { return store.updateSchema(value); }, className: "is-fixed", "$schemaUrl": schemaUrl, iframeUrl: iframeUrl, isMobile: store.isMobile })));
  }));
