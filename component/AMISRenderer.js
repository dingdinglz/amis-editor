amis.define('component/AMISRenderer.tsx', function(require, exports, module, define) {
  ...
  var qs_1 = (0, tslib_1.__importDefault)(require("node_modules/qs/lib/index"));
  ...
  function schema2component(schema, transform, session) {
      ...
      var SchemaRenderer = /** @class */ (function (_super) {
          ...
          SchemaRenderer.prototype.getEnv = function () {
              ...
              return (this.env = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, rootEnv), { session: session, isCurrentUrl: isCurrentUrl, updateLocation: props.updateLocation ||
          ...
          SchemaRenderer.prototype.render = function () {
              var _a = this.props, router = _a.router, match = _a.match, location = _a.location, history = _a.history, store = _a.store, schemaProp = _a.schema, jumpTo = _a.jumpTo, updateLocation = _a.updateLocation, embedMode = _a.embedMode, rest = (0, tslib_1.__rest)(_a, ["router", "match", "location", "history", "store", "schema", "jumpTo", "updateLocation", "embedMode"]);
              var finalSchema = schemaProp || schema;
              var body;
              finalSchema.type || (finalSchema.type = 'page');
              body = (0, amis_1.render)(finalSchema, (0, tslib_1.__assign)((0, tslib_1.__assign)({ location: location, data: amis_1.utils.createObject((0, tslib_1.__assign)((0, tslib_1.__assign)({}, match.params), { amisStore: store, pathname: location.pathname, params: match.params })) }, rest), { propsTransform: transform }), this.getEnv());
              return react_1.default.createElement(react_1.default.Fragment, null, body);
          };
          SchemaRenderer.displayName = 'SchemaRenderer';
          SchemaRenderer = (0, tslib_1.__decorate)([
