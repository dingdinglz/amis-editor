amis.define('node_modules/downshift/dist/downshift.cjs', function(require, exports, module, define) {

  'use strict';
  
  Object.defineProperty(exports, '__esModule', { value: true });
  
  var _objectWithoutPropertiesLoose = require('node_modules/@babel/runtime/helpers/objectWithoutPropertiesLoose');
  var _extends = require('node_modules/@babel/runtime/helpers/extends');
  var _assertThisInitialized = require('node_modules/@babel/runtime/helpers/assertThisInitialized');
  var _inheritsLoose = require('node_modules/@babel/runtime/helpers/inheritsLoose');
  var PropTypes = require('node_modules/prop-types/index');
  var react = require('node_modules/react/index');
  var reactIs = require('node_modules/react-is/index');
  var computeScrollIntoView = require('node_modules/compute-scroll-into-view/dist/index');
  ...
  var unknown = 'development' !== "production" ? '__autocomplete_unknown__' : 0;
  var mouseUp = 'development' !== "production" ? '__autocomplete_mouseup__' : 1;
  var itemMouseEnter = 'development' !== "production" ? '__autocomplete_item_mouseenter__' : 2;
  var keyDownArrowUp = 'development' !== "production" ? '__autocomplete_keydown_arrow_up__' : 3;
  var keyDownArrowDown = 'development' !== "production" ? '__autocomplete_keydown_arrow_down__' : 4;
  var keyDownEscape = 'development' !== "production" ? '__autocomplete_keydown_escape__' : 5;
  var keyDownEnter = 'development' !== "production" ? '__autocomplete_keydown_enter__' : 6;
  var keyDownHome = 'development' !== "production" ? '__autocomplete_keydown_home__' : 7;
  var keyDownEnd = 'development' !== "production" ? '__autocomplete_keydown_end__' : 8;
  var clickItem = 'development' !== "production" ? '__autocomplete_click_item__' : 9;
  var blurInput = 'development' !== "production" ? '__autocomplete_blur_input__' : 10;
  var changeInput = 'development' !== "production" ? '__autocomplete_change_input__' : 11;
  var keyDownSpaceButton = 'development' !== "production" ? '__autocomplete_keydown_space_button__' : 12;
  var clickButton = 'development' !== "production" ? '__autocomplete_click_button__' : 13;
  var blurButton = 'development' !== "production" ? '__autocomplete_blur_button__' : 14;
  var controlledPropUpdatedSelectedItem = 'development' !== "production" ? '__autocomplete_controlled_prop_updated_selected_item__' : 15;
  var touchEnd = 'development' !== "production" ? '__autocomplete_touchend__' : 16;
      ...
      function Downshift(_props) {
        ...
        _this.getItemProps = function (_temp7) {
          ...
          var _ref7 = _temp7 === void 0 ? {} : _temp7,
              ...
              item = _ref7$item === void 0 ? 'development' === 'production' ?
          /* istanbul ignore next */
  ...
  'development' !== "production" ? Downshift.propTypes = {
  ...
  var MenuKeyDownArrowDown = 'development' !== "production" ? '__menu_keydown_arrow_down__' : 0;
  var MenuKeyDownArrowUp = 'development' !== "production" ? '__menu_keydown_arrow_up__' : 1;
  var MenuKeyDownEscape = 'development' !== "production" ? '__menu_keydown_escape__' : 2;
  var MenuKeyDownHome = 'development' !== "production" ? '__menu_keydown_home__' : 3;
  var MenuKeyDownEnd = 'development' !== "production" ? '__menu_keydown_end__' : 4;
  var MenuKeyDownEnter = 'development' !== "production" ? '__menu_keydown_enter__' : 5;
  var MenuKeyDownSpaceButton = 'development' !== "production" ? '__menu_keydown_space_button__' : 6;
  var MenuKeyDownCharacter = 'development' !== "production" ? '__menu_keydown_character__' : 7;
  var MenuBlur = 'development' !== "production" ? '__menu_blur__' : 8;
  var MenuMouseLeave$1 = 'development' !== "production" ? '__menu_mouse_leave__' : 9;
  var ItemMouseMove$1 = 'development' !== "production" ? '__item_mouse_move__' : 10;
  var ItemClick$1 = 'development' !== "production" ? '__item_click__' : 11;
  var ToggleButtonClick$1 = 'development' !== "production" ? '__togglebutton_click__' : 12;
  var ToggleButtonKeyDownArrowDown = 'development' !== "production" ? '__togglebutton_keydown_arrow_down__' : 13;
  var ToggleButtonKeyDownArrowUp = 'development' !== "production" ? '__togglebutton_keydown_arrow_up__' : 14;
  var ToggleButtonKeyDownCharacter = 'development' !== "production" ? '__togglebutton_keydown_character__' : 15;
  var FunctionToggleMenu$1 = 'development' !== "production" ? '__function_toggle_menu__' : 16;
  var FunctionOpenMenu$1 = 'development' !== "production" ? '__function_open_menu__' : 17;
  var FunctionCloseMenu$1 = 'development' !== "production" ? '__function_close_menu__' : 18;
  var FunctionSetHighlightedIndex$1 = 'development' !== "production" ? '__function_set_highlighted_index__' : 19;
  var FunctionSelectItem$1 = 'development' !== "production" ? '__function_select_item__' : 20;
  var FunctionSetInputValue$1 = 'development' !== "production" ? '__function_set_input_value__' : 21;
  var FunctionReset$2 = 'development' !== "production" ? '__function_reset__' : 22;
  ...
  var InputKeyDownArrowDown = 'development' !== "production" ? '__input_keydown_arrow_down__' : 0;
  var InputKeyDownArrowUp = 'development' !== "production" ? '__input_keydown_arrow_up__' : 1;
  var InputKeyDownEscape = 'development' !== "production" ? '__input_keydown_escape__' : 2;
  var InputKeyDownHome = 'development' !== "production" ? '__input_keydown_home__' : 3;
  var InputKeyDownEnd = 'development' !== "production" ? '__input_keydown_end__' : 4;
  var InputKeyDownEnter = 'development' !== "production" ? '__input_keydown_enter__' : 5;
  var InputChange = 'development' !== "production" ? '__input_change__' : 6;
  var InputBlur = 'development' !== "production" ? '__input_blur__' : 7;
  var MenuMouseLeave = 'development' !== "production" ? '__menu_mouse_leave__' : 8;
  var ItemMouseMove = 'development' !== "production" ? '__item_mouse_move__' : 9;
  var ItemClick = 'development' !== "production" ? '__item_click__' : 10;
  var ToggleButtonClick = 'development' !== "production" ? '__togglebutton_click__' : 11;
  var FunctionToggleMenu = 'development' !== "production" ? '__function_toggle_menu__' : 12;
  var FunctionOpenMenu = 'development' !== "production" ? '__function_open_menu__' : 13;
  var FunctionCloseMenu = 'development' !== "production" ? '__function_close_menu__' : 14;
  var FunctionSetHighlightedIndex = 'development' !== "production" ? '__function_set_highlighted_index__' : 15;
  var FunctionSelectItem = 'development' !== "production" ? '__function_select_item__' : 16;
  var FunctionSetInputValue = 'development' !== "production" ? '__function_set_input_value__' : 17;
  var FunctionReset$1 = 'development' !== "production" ? '__function_reset__' : 18;
  var ControlledPropUpdatedSelectedItem = 'development' !== "production" ? '__controlled_prop_updated_selected_item__' : 19;
  ...
  var SelectedItemClick = 'development' !== "production" ? '__selected_item_click__' : 0;
  var SelectedItemKeyDownDelete = 'development' !== "production" ? '__selected_item_keydown_delete__' : 1;
  var SelectedItemKeyDownBackspace = 'development' !== "production" ? '__selected_item_keydown_backspace__' : 2;
  var SelectedItemKeyDownNavigationNext = 'development' !== "production" ? '__selected_item_keydown_navigation_next__' : 3;
  var SelectedItemKeyDownNavigationPrevious = 'development' !== "production" ? '__selected_item_keydown_navigation_previous__' : 4;
  var DropdownKeyDownNavigationPrevious = 'development' !== "production" ? '__dropdown_keydown_navigation_previous__' : 5;
  var DropdownKeyDownBackspace = 'development' !== "production" ? '__dropdown_keydown_backspace__' : 6;
  var DropdownClick = 'development' !== "production" ? '__dropdown_click__' : 7;
  var FunctionAddSelectedItem = 'development' !== "production" ? '__function_add_selected_item__' : 8;
  var FunctionRemoveSelectedItem = 'development' !== "production" ? '__function_remove_selected_item__' : 9;
  var FunctionSetSelectedItems = 'development' !== "production" ? '__function_set_selected_items__' : 10;
  var FunctionSetActiveIndex = 'development' !== "production" ? '__function_set_active_index__' : 11;
  var FunctionReset = 'development' !== "production" ? '__function_reset__' : 12;
