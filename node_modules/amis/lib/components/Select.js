amis.define('node_modules/amis/lib/components/Select', function(require, exports, module, define) {
  ...
  var virtual_list_1 = (0, tslib_1.__importDefault)(require("node_modules/amis/lib/components/virtual-list/index"));
  ...
  var Schema_1 = require("node_modules/amis/lib/Schema");
  ...
  var WithRemoteConfig_1 = require("node_modules/amis/lib/components/WithRemoteConfig");
  ...
  var Select = /** @class */ (function (_super) {
      ...
      function Select(props) {
          ...
          _this.clearSearchValue = _this.clearSearchValue.bind(_this);
      ...
      Select.prototype.renderValue = function (_a) {
          ...
          var _b = this.props, multiple = _b.multiple, valuesNoWrap = _b.valuesNoWrap, placeholder = _b.placeholder, ns = _b.classPrefix, labelField = _b.labelField, disabled = _b.disabled, __ = _b.translate;
          var selection = this.state.selection;
          ...
          return selection.map(function (item, index) {
              if (!multiple) {
                  return (react_1.default.createElement("div", { className: ns + "Select-value", key: index }, "" + item[labelField || 'label']));
              }
              return valuesNoWrap ? ("" + item[labelField || 'label'] + (index === selection.length - 1 ? '' : ' + ')) : (react_1.default.createElement("div", { className: ns + "Select-value", key: index },
      ...
      Select.prototype.renderOuter = function (_a) {
          ...
          var renderItem = function (_a) {
              ...
              return (react_1.default.createElement("div", (0, tslib_1.__assign)({}, getItemProps({
                  ...
                  renderMenu ? (checkAll || multiple ? (react_1.default.createElement(Checkbox_1.default, { checked: checked, trueValue: item.value, onChange: function () {
          ...
          return (react_1.default.createElement(Overlay_1.default, { container: popOverContainer || this.getTarget, target: this.getTarget, placement: overlayPlacement, show: true },
              react_1.default.createElement(PopOver_1.default, { overlay: true, className: cx('Select-popover', popoverClassName), style: {
                      minWidth: this.target ? this.target.offsetWidth : 'auto'
                  }, onHide: this.close }, menu)));
      };
      Select.prototype.render = function () {
          var _this = this;
          var _a = this.props, cx = _a.classnames, multiple = _a.multiple, valuesNoWrap = _a.valuesNoWrap, searchable = _a.searchable, inline = _a.inline, className = _a.className, value = _a.value, loading = _a.loading, clearable = _a.clearable, labelField = _a.labelField, disabled = _a.disabled, checkAll = _a.checkAll, borderMode = _a.borderMode;
          var selection = this.state.selection;
          var inputValue = this.state.inputValue;
          ...
          return (react_1.default.createElement(downshift_1.default, { selectedItem: selection, highlightedIndex: this.state.highlightedIndex, isOpen: this.state.isOpen, inputValue: inputValue, onChange: 
              ...
              return (react_1.default.createElement("div", { tabIndex: disabled ? -1 : 0, onKeyPress: _this.handleKeyPress, onClick: _this.toggle, onFocus: _this.onFocus, onBlur: _this.onBlur, className: cx("Select", (_a = {},
                      ...
                      _a["Select--border" + (0, helper_1.ucFirst)(borderMode)] = borderMode,
                      _a), className) },
