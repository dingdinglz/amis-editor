amis.define('node_modules/amis/lib/components/BaiduMapPicker', function(require, exports, module, define) {
  ...
  var BaiduMapPicker = /** @class */ (function (_super) {
      ...
      BaiduMapPicker.prototype.componentDidMount = function () {
          if (window.BMap) {
              ...
              (0, helper_1.loadScript)("//api.map.baidu.com/api?v=3.0&ak=" + this.props.ak + "&callback={{callback}}").then(this.initMap);
          }
      };
