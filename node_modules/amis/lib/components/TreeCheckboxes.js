amis.define('node_modules/amis/lib/components/TreeCheckboxes', function(require, exports, module, define) {
  ...
  var TreeCheckboxes = /** @class */ (function (_super) {
      (0, tslib_1.__extends)(TreeCheckboxes, _super);
      ...
      TreeCheckboxes.defaultProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, Checkboxes_1.BaseCheckboxes.defaultProps), { expand: 'first' });
      return TreeCheckboxes;
  }(Checkboxes_1.BaseCheckboxes));
  exports.TreeCheckboxes = TreeCheckboxes;
  exports.default = (0, theme_1.themeable)((0, locale_1.localeable)((0, uncontrollable_1.uncontrollable)(TreeCheckboxes, {
      value: 'onChange'
  })));
