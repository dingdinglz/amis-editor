amis.define('node_modules/amis/lib/components/WithRemoteConfig', function(require, exports, module, define) {
  ...
  var WithStore_1 = require("node_modules/amis/lib/components/WithStore");
          ...
          var result = (0, hoist_non_react_statics_1.default)((0, WithStore_1.withStore)(function () { return exports.Store.create(); })((_a = /** @class */ (function (_super) {
                  ...
                  class_1.prototype.loadConfig = function (ctx) {
                      ...
                      return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
                          var env, _a, store, source;
                          return (0, tslib_1.__generator)(this, function (_b) {
                              switch (_b.label) {
                                  case 0:
                                      env = this.props.env || this.context;
                                      _a = this.props, store = _a.store, source = _a.source;
                  ...
                  class_1.prototype.deferLoadConfig = function (item) {
                      var _a, _b;
                      return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
                          var _c, store, source, data, deferApi, env, indexes, ret, response, e_2, ret2;
                          return (0, tslib_1.__generator)(this, function (_d) {
                              switch (_d.label) {
                                  case 0:
                                      _c = this.props, store = _c.store, source = _c.source, data = _c.data, deferApi = _c.deferApi;
                                      env = this.props.env || this.context;
