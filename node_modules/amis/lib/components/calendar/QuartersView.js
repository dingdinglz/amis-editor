amis.define('node_modules/amis/lib/components/calendar/QuartersView', function(require, exports, module, define) {
  ...
  var QuarterView = /** @class */ (function (_super) {
      ...
      QuarterView.prototype.renderQuarters = function () {
          ...
          while (i < 5) {
              classes = 'rdtQuarter';
              isDisabled = !isValid((0, moment_1.default)(year + "-" + i, 'YYYY-Q'));
              if (isDisabled)
                  classes += ' rdtDisabled';
