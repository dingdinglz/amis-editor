amis.define('node_modules/amis/lib/components/SparkLine', function(require, exports, module, define) {
  ...
  var SparkLine = /** @class */ (function (_super) {
      ...
      SparkLine.prototype.renderLines = function () {
          ...
          var lineD = points
              .map(function (value, index) { return (index === 0 ? 'M' : 'L') + " " + value.x + " " + value.y; })
              .join(' ');
          var areaD = lineD + " V " + height + " L 0 " + height + " Z";
      ...
      SparkLine.prototype.render = function () {
          ...
          return (react_1.default.createElement("div", { className: cx('Sparkline', className, onClick ? 'Sparkline--clickable' : ''), onClick: onClick }, Array.isArray(value) && value.length > 1 ? (react_1.default.createElement("svg", { className: cx('Sparkline-svg'), width: width, height: height, viewBox: "0 0 " + width + " " + height }, this.renderLines())) : (placeholder !== null && placeholder !== void 0 ? placeholder : __('placeholder.empty'))));
      };
