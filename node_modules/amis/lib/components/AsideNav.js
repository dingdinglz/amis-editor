amis.define('node_modules/amis/lib/components/AsideNav', function(require, exports, module, define) {
          ...
          navigations.forEach(function (navigation, index) {
              ...
              if (navigation.prefix) {
                  var prefix = typeof navigation.prefix === 'function'
                      ...
                      : navigation.prefix;
                  links.push(react_1.default.cloneElement(prefix, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, prefix.props), { key: index + "-prefix" })));
              }
              navigation.label &&
              ...
              if (navigation.affix) {
                  var affix = typeof navigation.affix === 'function'
                      ...
                      : navigation.affix;
                  links.push(react_1.default.cloneElement(affix, (0, tslib_1.__assign)((0, tslib_1.__assign)({}, affix.props), { key: index + "-affix" })));
              }
          });
