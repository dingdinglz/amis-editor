amis.define('node_modules/amis/lib/components/condition-builder/Expression', function(require, exports, module, define) {
  ...
  var Field_1 = (0, tslib_1.__importDefault)(require("node_modules/amis/lib/components/condition-builder/Field"));
  var helper_1 = require("node_modules/amis/lib/utils/helper");
  var Value_1 = (0, tslib_1.__importDefault)(require("node_modules/amis/lib/components/condition-builder/Value"));
  var InputSwitch_1 = (0, tslib_1.__importDefault)(require("node_modules/amis/lib/components/condition-builder/InputSwitch"));
  var Func_1 = (0, tslib_1.__importDefault)(require("node_modules/amis/lib/components/condition-builder/Func"));
  var theme_1 = require("node_modules/amis/lib/theme");
  var Formula_1 = (0, tslib_1.__importDefault)(require("node_modules/amis/lib/components/condition-builder/Formula"));
  var fieldMap = {
      value: '值',
      field: '字段',
      func: '函数',
  ...
  var Expression = /** @class */ (function (_super) {
      ...
      Expression.prototype.render = function () {
          var _a, _b, _c, _d, _e;
          var _f = this.props, value = _f.value, valueField = _f.valueField, allowedTypes = _f.allowedTypes, funcs = _f.funcs, fields = _f.fields, op = _f.op, cx = _f.classnames, fieldClassName = _f.fieldClassName, config = _f.config, data = _f.data, disabled = _f.disabled, searchable = _f.searchable;
          ...
          return (react_1.default.createElement(react_1.default.Fragment, null,
              ...
              inputType === 'field' ? (react_1.default.createElement(Field_1.default, { value: (_d = value) === null || _d === void 0 ? void 0 : _d.field, onChange: this.handleFieldChange, fieldClassName: fieldClassName, disabled: disabled, searchable: searchable, options: valueField
