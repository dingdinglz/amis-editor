amis.define('node_modules/amis/lib/components/condition-builder/index', function(require, exports, module, define) {
  ...
  var config_1 = (0, tslib_1.__importDefault)(require("node_modules/amis/lib/components/condition-builder/config"));
  var helper_1 = require("node_modules/amis/lib/utils/helper");
  var Animation_1 = (0, tslib_1.__importDefault)(require("node_modules/amis/lib/utils/Animation"));
  var QueryBuilder = /** @class */ (function (_super) {
      ...
      QueryBuilder.prototype.render = function () {
          var _a = this.props, cx = _a.classnames, fieldClassName = _a.fieldClassName, fields = _a.fields, funcs = _a.funcs, onChange = _a.onChange, value = _a.value, showNot = _a.showNot, data = _a.data, disabled = _a.disabled, searchable = _a.searchable;
          ...
          return (react_1.default.createElement(Group_1.default, { config: this.config, funcs: funcs || this.config.funcs, fields: fields || this.config.fields, value: normalizedValue, onChange: onChange, classnames: cx, fieldClassName: fieldClassName, removeable: false, onDragStart: this.handleDragStart, showNot: showNot, data: data, disabled: disabled, searchable: searchable }));
      };
      var _a, _b, _c;
