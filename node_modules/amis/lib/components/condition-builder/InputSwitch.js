amis.define('node_modules/amis/lib/components/condition-builder/InputSwitch', function(require, exports, module, define) {
  ...
  function InputSwitch(_a) {
      ...
      return (react_1.default.createElement(PopOverContainer_1.default, { popOverRender: function (_a) {
              ...
              return (react_1.default.createElement(ListRadios_1.default, { onClick: onClose, option2value: option2value, onChange: onChange, options: options, value: value, showRadio: false, disabled: disabled }));
          } }, function (_a) {
