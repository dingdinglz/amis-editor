amis.define('node_modules/amis/lib/components/condition-builder/Func', function(require, exports, module, define) {
  ...
  var ConditionFunc = /** @class */ (function (_super) {
      ...
      ConditionFunc.prototype.render = function () {
          var _this = this;
          var _a = this.props, value = _a.value, cx = _a.classnames, fieldClassName = _a.fieldClassName, funcs = _a.funcs, disabled = _a.disabled;
          var func = value
          ...
          return (react_1.default.createElement("div", { className: cx('CBFunc') },
              react_1.default.createElement(PopOverContainer_1.default, { popOverRender: function (_a) {
                  ...
                  return (react_1.default.createElement("div", { className: cx('CBFunc-select') },
                      react_1.default.createElement(ResultBox_1.default, { className: cx('CBGroup-fieldInput', fieldClassName, isOpened ? 'is-active' : ''), ref: ref, allowInput: false, result: func === null || func === void 0 ? void 0 : func.label, onResultChange: helper_1.noop, onResultClick: onClick, placeholder: "\u8BF7\u9009\u62E9\u5B57\u6BB5", disabled: disabled },
  ...
  exports.default = (0, theme_1.themeable)(ConditionFunc);
