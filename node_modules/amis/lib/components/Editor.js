amis.define('node_modules/amis/lib/components/Editor', function(require, exports, module, define) {
  ...
  var Editor = /** @class */ (function (_super) {
      ...
      Editor.prototype.loadMonaco = function () {
          var _this = this;
          Promise.resolve().then(function () { return new Promise(function(resolve){require(['loadMonacoEditor.ts'], function(ret) {resolve(tslib_1.__importStar(ret));})}); }).then(function (monaco) { return _this.initMonaco(monaco); });
      };
      ...
      Editor.prototype.render = function () {
          ...
          style.width = width;
          style.height = height;
          return (react_1.default.createElement("div", { className: (0, classnames_1.default)(ns + "MonacoEditor", { 'is-fullscreen': this.state.isFullscreen }, className), style: style, ref: this.wrapperRef }, this.editor && this.props.allowFullscreen ? (react_1.default.createElement("div", { className: (0, classnames_1.default)(ns + "MonacoEditor-header") },
              react_1.default.createElement("a", { className: (0, classnames_1.default)('Modal-close', ns + "MonacoEditor-fullscreen"), "data-tooltip": this.state.isFullscreen
