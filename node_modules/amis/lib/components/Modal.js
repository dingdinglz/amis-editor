amis.define('node_modules/amis/lib/components/Modal', function(require, exports, module, define) {
  ...
  var Modal = /** @class */ (function (_super) {
      ...
      function Modal() {
          ...
          _this.modalRef = function (ref) {
              ...
              if (ref) {
                  ...
                  ref.classList.add(ns + "Modal--" + (0, ModalManager_1.current)() + "th");
              }
              else {
      ...
      Modal.prototype.handleRootClickCapture = function (e) {
          ...
          this.isRootClosed = !!(isLeftButton &&
              ...
              ((!this.modalDom.contains(target) && !target.closest('[role=dialog]')) ||
                  (target.matches("." + ns + "Modal") && target === this.modalDom))); // 干脆过滤掉来自弹框里面的点击
      };
      ...
      Modal.Header = (0, theme_1.themeable)((0, locale_1.localeable)(function (_a) {
          var cx = _a.classnames, className = _a.className, showCloseButton = _a.showCloseButton, onClose = _a.onClose, children = _a.children, classPrefix = _a.classPrefix, __ = _a.translate, rest = (0, tslib_1.__rest)(_a, ["classnames", "className", "showCloseButton", "onClose", "children", "classPrefix", "translate"]);
      ...
      Modal.Title = (0, theme_1.themeable)(function (_a) {
          var cx = _a.classnames, className = _a.className, children = _a.children, classPrefix = _a.classPrefix, rest = (0, tslib_1.__rest)(_a, ["classnames", "className", "children", "classPrefix"]);
