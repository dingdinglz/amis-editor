amis.define('node_modules/amis/lib/renderers/Flex', function(require, exports, module, define) {
  ...
  var Flex = /** @class */ (function (_super) {
      ...
      Flex.prototype.render = function () {
          ...
          return (react_1.default.createElement("div", { style: flexStyle, className: className }, (Array.isArray(items)
              ? items
              : items
                  ? [items]
                  : []).map(function (item, key) {
              return render("flexItem/" + key, item, { key: "flexItem/" + key });
          })));
      };
      Flex.defaultProps = {
          direction: 'row',
