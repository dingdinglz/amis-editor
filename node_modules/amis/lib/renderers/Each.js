amis.define('node_modules/amis/lib/renderers/Each', function(require, exports, module, define) {
  ...
  var Each = /** @class */ (function (_super) {
      ...
      Each.prototype.render = function () {
          ...
          var value = (0, helper_1.getPropValue)(this.props, function (props) { return props.source && !props.name
              ? (0, tpl_builtin_1.resolveVariableAndFilter)(props.source, props.data, '| raw') : undefined; });
