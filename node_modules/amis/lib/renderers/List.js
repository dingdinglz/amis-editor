amis.define('node_modules/amis/lib/renderers/List', function(require, exports, module, define) {
  ...
  var ListItem = /** @class */ (function (_super) {
      ...
      ListItem.prototype.renderRight = function () {
          ...
          if (Array.isArray(actions)) {
              return (react_1.default.createElement("div", { className: cx('ListItem-actions') }, actions.map(function (action, index) {
                  ...
                  return render("action/" + index, (0, tslib_1.__assign)({ size: 'sm', level: 'link', type: 'button' }, action // todo 等后面修复了干掉 https://github.com/microsoft/TypeScript/pull/38577
                  ), {
                      key: index,
      ...
      ListItem.prototype.render = function () {
          ...
          return (react_1.default.createElement("div", { onClick: (checkOnItemClick && checkable) || itemAction
                  ? this.handleClick
                  : undefined, className: cx("ListItem ListItem--actions-at-" + (actionsPosition || 'right'), {
