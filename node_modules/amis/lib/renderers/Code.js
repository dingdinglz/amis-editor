amis.define('node_modules/amis/lib/renderers/Code', function(require, exports, module, define) {
  ...
  var Code = /** @class */ (function (_super) {
      ...
      Code.prototype.componentDidMount = function () {
          var _this = this;
          Promise.resolve().then(function () { return new Promise(function(resolve){require(['loadMonacoEditor.ts'], function(ret) {resolve(tslib_1.__importStar(ret));})}); }).then(function (monaco) { return _this.handleMonaco(monaco); });
      };
      ...
      Code.prototype.render = function () {
          var _a = this.props, className = _a.className, cx = _a.classnames, data = _a.data, customLang = _a.customLang;
          ...
          return (react_1.default.createElement("code", { ref: this.codeRef, className: cx("Code", className), "data-lang": language }, sourceCode));
      };
      Code.defaultProps = {
          language: 'plaintext',
          editorTheme: 'vs',
