amis.define('node_modules/amis/lib/renderers/PopOver', function(require, exports, module, define) {
          ...
          var PopOverComponent = /** @class */ (function (_super) {
              ...
              PopOverComponent.prototype.buildSchema = function () {
                  ...
                  if (popOver === true) {
                      ...
                      schema = (0, tslib_1.__assign)({ type: popOver.mode, actions: [
                              {
              ...
              PopOverComponent.prototype.renderPopOver = function () {
                  ...
                  return isFixed ? (react_1.default.createElement(RootClose_1.RootClose, { disabled: !this.state.isOpened, onRootClose: this.closePopOver }, function (ref) {
                      var _a, _b;
                      return (react_1.default.createElement("div", { className: cx("PopOverAble--fixed PopOverAble--" + position), onMouseLeave: ((_a = popOver) === null || _a === void 0 ? void 0 : _a.trigger) === 'hover'
                              ? _this.closePopOver
