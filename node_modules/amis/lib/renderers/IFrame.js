amis.define('node_modules/amis/lib/renderers/IFrame', function(require, exports, module, define) {
  ...
  var IFrame = /** @class */ (function (_super) {
      ...
      IFrame.prototype.reload = function (subpath, query) {
          ...
          var _a = this.props, src = _a.src, data = _a.data;
          if (src) {
              this.IFrameRef.current.src = (0, api_1.buildApi)(src, data).url;
          }
      };
      ...
      IFrame.prototype.receive = function (values) {
          ...
          if ((0, api_1.isApiOutdated)(src, src, data, newData)) {
              this.IFrameRef.current.src = (0, api_1.buildApi)(src, newData).url;
          }
      };
      ...
      IFrame.prototype.render = function () {
          ...
          var finalSrc = src ? (0, api_1.buildApi)(src, data).url : undefined;
