amis.define('node_modules/amis/lib/renderers/Dialog', function(require, exports, module, define) {
  ...
  var DialogRenderer = /** @class */ (function (_super) {
      ...
      DialogRenderer.prototype.handleAction = function (e, action, data, throwErrors, delegate) {
          ...
          if (action.type === 'reset') {
              ...
              store.setCurrentAction(action);
              this.tryChildrenToHandle((0, tslib_1.__assign)((0, tslib_1.__assign)({}, action), { actionType: 'submit' }), data, action) || this.handleSelfClose();
          }
          else if (action.actionType === 'next' || action.actionType === 'prev') {
              store.setCurrentAction(action);
              if (action.type === 'submit') {
                  this.tryChildrenToHandle((0, tslib_1.__assign)((0, tslib_1.__assign)({}, action), { actionType: 'submit', close: true }), data, action) || this.handleSelfClose();
              }
              else {
