amis.define('node_modules/amis/lib/renderers/Form/Item', function(require, exports, module, define) {
  ...
  var hoist_non_react_statics_1 = (0, tslib_1.__importDefault)(require("node_modules/hoist-non-react-statics/dist/hoist-non-react-statics.cjs"));
  ...
  var types_1 = require("node_modules/amis/lib/types");
  var tpl_1 = require("node_modules/amis/lib/utils/tpl");
  var WithStore_1 = require("node_modules/amis/lib/WithStore");
  var wrapControl_1 = require("node_modules/amis/lib/renderers/Form/wrapControl");
  var FormItemWrap = /** @class */ (function (_super) {
      ...
      function FormItemWrap(props) {
          ...
          if (model) {
              _this.reaction = (0, mobx_1.reaction)(function () { return "" + model.errors.join('') + model.isFocused + model.dialogOpen; }, function () { return _this.forceUpdate(); });
          }
          return _this;
      }
      ...
      return function (Control) {
          ...
          return (0, wrapControl_1.wrapControl)((0, hoist_non_react_statics_1.default)((_a = /** @class */ (function (_super) {
                  ...
                  class_1.prototype.renderControl = function () {
                      ...
                      var controlSize = size || defaultSize;
                      return (react_1.default.createElement(Control, (0, tslib_1.__assign)({}, rest, { onOpenDialog: this.handleOpenDialog, size: config.sizeMutable !== false ? undefined : size, onFocus: this.handleFocus, onBlur: this.handleBlur, type: type, classnames: cx, ref: isSFC ? undefined : this.refFn, forwardedRef: isSFC ? this.refFn : undefined, formItem: model, className: cx("Form-control", (_a = {
                                  'is-inline': !!rest.inline,
                                  'is-error': model && !model.valid
                              },
