amis.define('node_modules/amis/lib/renderers/Form/InputImage', function(require, exports, module, define) {
  ...
  var Cropper = react_1.default.lazy(function () { return Promise.resolve().then(function () { return new Promise(function(resolve){require(['node_modules/react-cropper/dist/react-cropper.umd'], function(ret) {resolve(tslib_1.__importStar(ret));})}); }); });
  ...
  var attr_accept_1 = (0, tslib_1.__importDefault)(require("node_modules/attr-accept/dist/index"));
  var InputFile_1 = require("node_modules/amis/lib/renderers/Form/InputFile");
  ...
  var ImageControl = /** @class */ (function (_super) {
      ...
      ImageControl.prototype._upload = function (file, cb, onProgress) {
          ...
          this._send(file, this.props.receiver, {}, onProgress)
              ...
              var obj = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, ret.data), { state: 'uploaded' });
                  ...
                  isDragActive || isDragAccept || isDragReject ? (react_1.default.createElement("div", { className: cx('ImageControl-acceptTip', {
                      ...
                      files && files.length
                          ? files.map(function (file, key) { return (react_1.default.createElement("div", { key: file.id || key, className: cx('ImageControl-item', {
                              ...
                              react_1.default.createElement("a", { className: cx('ImageControl-itemClear'), "data-tooltip": __('Select.clear'), "data-position": "bottom", onClick: _this_1.removeFile.bind(_this_1, file, key) },
                                  react_1.default.createElement(icons_1.Icon, { icon: "close", className: "icon" })),
                              react_1.default.createElement("a", { className: cx('ImageControl-retryBtn', {
                                      'is-disabled': disabled
                                  }, fixedSize ? 'ImageControl-fixed-size' : '', fixedSize ? fixedSizeClassName : ''), onClick: _this_1.handleRetry.bind(_this_1, key) },
                                  react_1.default.createElement(icons_1.Icon, { icon: "retry", className: "icon" }),
