amis.define('node_modules/amis/lib/renderers/Form/FieldSet', function(require, exports, module, define) {
  ...
  var Collapse_1 = (0, tslib_1.__importDefault)(require("node_modules/amis/lib/renderers/Collapse"));
  var FieldSetControl = /** @class */ (function (_super) {
      ...
      FieldSetControl.prototype.renderBody = function () {
          ...
          return (react_1.default.createElement("div", { className: cx("Form--" + (props.mode || formMode || 'normal'), formClassName) }, body ? render('body', body, props) : null));
      };
