amis.define('node_modules/amis/lib/renderers/Form/ButtonGroupSelect', function(require, exports, module, define) {
      ...
      ButtonGroupControl.prototype.render = function (props) {
          ...
          if (options && options.length) {
              ...
              body = buttons.map(function (button, key) {
                  return render("button/" + key, (0, tslib_1.__assign)({ size: size, block: block, activeLevel: btnActiveLevel }, button), {
                      key: key,
          ...
          return (react_1.default.createElement("div", { className: cx("ButtonGroup", (_a = {
                  ...
                  _a), className) }, body.length ? (body) : (react_1.default.createElement("span", { className: ns + "ButtonGroup-placeholder" }, __(placeholder)))));
      };
      var _a;
