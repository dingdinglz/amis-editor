amis.define('node_modules/amis/lib/renderers/Form/index', function(require, exports, module, define) {
  ...
  var flatten_1 = (0, tslib_1.__importDefault)(require("node_modules/lodash/flatten"));
  ...
  var Form = /** @class */ (function (_super) {
      ...
      Form.prototype.renderChildren = function (children, region, otherProps) {
          ...
          if (this.props.mode === 'row') {
              ...
              return (react_1.default.createElement("div", { className: ns_1 + "Form-row" }, children.map(function (control, key) {
                  return ~['hidden', 'formula'].indexOf(control.type) ||
                      control.mode === 'inline' ? (_this.renderChild(control, key, otherProps)) : (react_1.default.createElement("div", { key: key, className: (0, classnames_1.default)(ns_1 + "Form-col", control.columnClassName) }, _this.renderChild(control, '', (0, tslib_1.__assign)((0, tslib_1.__assign)({}, otherProps), { mode: 'row' }))));
              })));
          }
      ...
      Form.prototype.renderBody = function () {
          var _a = this.props, body = _a.body, mode = _a.mode, className = _a.className, cx = _a.classnames, debug = _a.debug, $path = _a.$path, store = _a.store, render = _a.render;
