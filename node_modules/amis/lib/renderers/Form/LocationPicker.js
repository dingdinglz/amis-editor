amis.define('node_modules/amis/lib/renderers/Form/LocationPicker', function(require, exports, module, define) {
  ...
  var LocationPicker_1 = (0, tslib_1.__importDefault)(require("node_modules/amis/lib/components/LocationPicker"));
  var LocationControl = /** @class */ (function (_super) {
      ...
      LocationControl.prototype.render = function () {
          return (react_1.default.createElement("div", { className: this.props.classnames('LocationControl') },
              react_1.default.createElement(LocationPicker_1.default, (0, tslib_1.__assign)({}, this.props))));
      };
