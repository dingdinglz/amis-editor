amis.define('node_modules/amis/lib/renderers/Form/InputSubForm', function(require, exports, module, define) {
  ...
  var SubFormControl = /** @class */ (function (_super) {
      ...
      SubFormControl.prototype.initDragging = function () {
          ...
          this.sortable = new sortablejs_1.default(dom.querySelector("." + ns + "SubForm-values"), {
      ...
      SubFormControl.prototype.render = function () {
          ...
          return (react_1.default.createElement("div", { className: (0, classnames_1.default)(ns + "SubFormControl", className) },
