amis.define('node_modules/amis/lib/renderers/Form/InputRichText', function(require, exports, module, define) {
  ...
  function loadRichText(type) {
      ...
      return function () {
          return type === 'tinymce'
              ? Promise.resolve().then(function () { return new Promise(function(resolve){require(['node_modules/amis/lib/components/Tinymce'], function(ret) {resolve(tslib_1.__importStar(ret));})}); }).then(function (item) { return item.default; })
              : Promise.resolve().then(function () { return new Promise(function(resolve){require(['node_modules/amis/lib/components/RichText'], function(ret) {resolve(tslib_1.__importStar(ret));})}); }).then(function (item) { return item.default; });
      };
  }
