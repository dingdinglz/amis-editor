amis.define('node_modules/amis/lib/renderers/Form/DiffEditor', function(require, exports, module, define) {
  ...
  function loadComponent() {
      return Promise.resolve().then(function () { return new Promise(function(resolve){require(['node_modules/amis/lib/components/Editor'], function(ret) {resolve(tslib_1.__importStar(ret));})}); }).then(function (item) { return item.default; });
  }
