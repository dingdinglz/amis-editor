amis.define('node_modules/amis/lib/renderers/Form/ChartRadios', function(require, exports, module, define) {
      ...
      ChartRadiosControl.prototype.render = function () {
          ...
          var config = (0, tslib_1.__assign)((0, tslib_1.__assign)({ legend: {
                  ...
                  formatter: function (params) {
                      return params.name + "\uFF1A" + params.value[chartValueField || valueField || 'value'] + "\uFF08" + params.percent + "%\uFF09";
                  }
              }, series: [
                  {
                      type: 'pie',
