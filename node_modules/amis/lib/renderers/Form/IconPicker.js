amis.define('node_modules/amis/lib/renderers/Form/IconPicker', function(require, exports, module, define) {
  ...
  var keycode_1 = (0, tslib_1.__importDefault)(require("node_modules/keycode/index"));
  var downshift_1 = tslib_1.__importStar(require("node_modules/downshift/dist/downshift.cjs"));
  var helper_1 = require("node_modules/amis/lib/utils/helper");
  var IconPickerIcons_1 = require("node_modules/amis/lib/renderers/Form/IconPickerIcons");
  ...
  var IconPickerControl = /** @class */ (function (_super) {
      ...
      IconPickerControl.prototype.renderFontIcons = function () {
          var _this = this;
          var _a = this.props, className = _a.className, inputOnly = _a.inputOnly, placeholder = _a.placeholder, cx = _a.classnames, name = _a.name, value = _a.value, noDataTip = _a.noDataTip, disabled = _a.disabled, __ = _a.translate;
      ...
      IconPickerControl.prototype.render = function () {
          ...
          return (react_1.default.createElement("div", { className: (0, classnames_1.default)(className, ns + "IconPickerControl", {
