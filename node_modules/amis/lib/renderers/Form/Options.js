amis.define('node_modules/amis/lib/renderers/Form/Options', function(require, exports, module, define) {
  ...
  function registerOptionsControl(config) {
      ...
      var FormOptionsItem = /** @class */ (function (_super) {
          ...
          function FormOptionsItem(props) {
              ...
              if (formItem) {
                  formItem.setOptions((0, Select_1.normalizeOptions)(options), _this.changeOptionValue, data);
          ...
          FormOptionsItem.prototype.componentDidUpdate = function (prevProps) {
              ...
              if (prevProps.options !== props.options && formItem) {
                  formItem.setOptions((0, Select_1.normalizeOptions)(props.options || []), this.changeOptionValue, props.data);
                  this.normalizeValue();
              }
                  ...
                  if ((0, tpl_builtin_1.isPureVariable)(props.source)) {
                      ...
                      if (prevOptions !== options) {
                          formItem.setOptions((0, Select_1.normalizeOptions)(options || []), this.changeOptionValue, props.data);
                          this.normalizeValue();
                      }
                  }
          ...
          FormOptionsItem.prototype.syncAutoFill = function (value) {
              ...
              if (autoFill && !(0, helper_1.isEmpty)(autoFill) && formItem.filteredOptions.length) {
                  ...
                  onBulkChange === null || onBulkChange === void 0 ? void 0 : onBulkChange(toSync);
              }
          };
          ...
          FormOptionsItem.prototype.handleToggleAll = function () {
              var _a = this.props, value = _a.value, onChange = _a.onChange, formItem = _a.formItem;
              if (!formItem) {
                  return;
              }
              var selectedOptions = formItem.getSelectedOptions(value);
          ...
          FormOptionsItem.prototype.reloadOptions = function (setError, isInit) {
              ...
              if (formItem && (0, tpl_builtin_1.isPureVariable)(source)) {
                  (0, mobx_state_tree_1.isAlive)(formItem) &&
                      formItem.setOptions((0, Select_1.normalizeOptions)((0, tpl_builtin_1.resolveVariableAndFilter)(source, data, '| raw') || []), this.changeOptionValue, data);
                  return;
              }
          ...
          FormOptionsItem.prototype.deferLoad = function (option) {
              ...
              formItem === null || formItem === void 0 ? void 0 : formItem.deferLoadOptions(option, api, (0, helper_1.createObject)(data, option));
          };
          ...
          FormOptionsItem.prototype.setOptions = function (options, skipNormalize) {
              ...
              var formItem = this.props.formItem;
              formItem &&
                  formItem.setOptions(skipNormalize ? options : (0, Select_1.normalizeOptions)(options || []), this.changeOptionValue, this.props.data);
          };
          ...
          FormOptionsItem.prototype.handleOptionAdd = function (idx, value, skipForm) {
              ...
              return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
                  var _a, addControls, disabled, labelField, onOpenDialog, optionLabel, addApi, source, data, valueField, model, createBtnLabel, env, __, parent, ctx, result, _b, payload, e_1, options;
                  var _c;
                  return (0, tslib_1.__generator)(this, function (_d) {
                      switch (_d.label) {
                          ...
                          case 7:
                              ...
                              // 如果是懒加载的，只懒加载当前节点。
                              if (parent === null || parent === void 0 ? void 0 : parent.defer) {
          ...
          FormOptionsItem.prototype.handleOptionDelete = function (value) {
              return (0, tslib_1.__awaiter)(this, void 0, void 0, function () {
                  var _a, deleteConfirmText, disabled, data, deleteApi, env, model, source, valueField, __, ctx, confirmed, _b, result, options, indexes, e_3;
                  return (0, tslib_1.__generator)(this, function (_c) {
                      switch (_c.label) {
                          case 0:
                              ...
                              return [4 /*yield*/, env.confirm((0, tpl_1.filter)(deleteConfirmText, ctx))];
                          case 1:
                              _b = _c.sent();
                              return [3 /*break*/, 3];
                          case 2:
          ...
          (0, tslib_1.__decorate)([
              helper_1.autobind,
              (0, tslib_1.__metadata)("design:type", Function),
              (0, tslib_1.__metadata)("design:paramtypes", [typeof (_c = typeof Array !== "undefined" && Array) === "function" ? _c : Object, Object]),
              (0, tslib_1.__metadata)("design:returntype", void 0)
