amis.define('node_modules/amis/lib/renderers/Form/InputFile', function(require, exports, module, define) {
  ...
  // @ts-ignore
  var mapLimit_1 = (0, tslib_1.__importDefault)(require("node_modules/async/mapLimit"));
  var InputImage_1 = (0, tslib_1.__importDefault)(require("node_modules/amis/lib/renderers/Form/InputImage"));
  ...
  var FileControl = /** @class */ (function (_super) {
      ...
      function FileControl(props) {
          ...
          if (value && value instanceof Blob) {
              ...
              files = (Array.isArray(value)
                  ? value
                  : joinValues
                      ? ("" + (value[valueField] || value)).split(delimiter)
                      : [value])
          ...
          [].slice.call(files, 0, allowed).forEach(function (file) {
              if (maxSize && file.size > maxSize) {
                  _this.props.env.alert(__('File.maxSize', {
                      filename: file[nameField] || file.name,
      ...
      FileControl.prototype.handleDropRejected = function (rejectedFiles, evt) {
          ...
          env.alert(__('File.invalidType', {
              files: files.map(function (item) { return "\u300C" + item[nameField] + "\u300D"; }).join(' '),
              accept: accept
          }));
      };
      FileControl.prototype.handleClickFile = function (file, e) {
          ...
          e.preventDefault();
          e.stopPropagation();
          var _c = this.props, data = _c.data, env = _c.env, downloadUrl = _c.downloadUrl;
          ...
          var api = typeof downloadUrl === 'string' && !~downloadUrl.indexOf('$')
              ...
              : downloadUrl
                  ...
                  : "" + fileUrl;
          if (api) {
              var ctx = (0, helper_1.createObject)(data, (0, tslib_1.__assign)({}, file));
      ...
      FileControl.prototype.onChange = function (changeImmediately) {
          var _a = this.props, multiple = _a.multiple, onChange = _a.onChange, joinValues = _a.joinValues, extractValue = _a.extractValue, valueField = _a.valueField, delimiter = _a.delimiter, resetValue = _a.resetValue, asBlob = _a.asBlob, autoFill = _a.autoFill, onBulkChange = _a.onBulkChange;
      ...
      FileControl.prototype.syncAutoFill = function () {
          var _a = this.props, autoFill = _a.autoFill, multiple = _a.multiple, onBulkChange = _a.onBulkChange;
          if (!(0, helper_1.isEmpty)(autoFill)) {
              var files = this.state.files.filter(function (file) { return ~['uploaded', 'init', 'ready'].indexOf(file.state); });
              var toSync = (0, tpl_builtin_1.dataMapping)(autoFill, multiple
                  ? {
                      items: files
                  }
                  : files[0]);
      ...
      FileControl.prototype.uploadBigFile = function (file, receiver, params, config, onProgress) {
          ...
          return new Promise(function (resolve, reject) {
              ...
              function startChunk(ret) {
                  ...
                  (0, mapLimit_1.default)(tasks, 3, uploadPartFile(state, config), function (err, results) {
                      if (err) {
                          reject(err);
                      }
                      else {
                  ...
                  return (react_1.default.createElement("div", (0, tslib_1.__assign)({}, getRootProps({
                      ...
                      isDragActive ? (react_1.default.createElement("div", { className: cx('FileControl-acceptTip') }, __('File.dragDrop'))) : (react_1.default.createElement(react_1.default.Fragment, null,
                          (multiple && (!maxLength || files.length < maxLength)) ||
                              !multiple ? (react_1.default.createElement(Button_1.default, { level: "default", disabled: disabled, className: cx('FileControl-selectBtn', btnClassName), onClick: _this.handleSelect },
                          ...
                          Array.isArray(files) ? (react_1.default.createElement("ul", { className: cx('FileControl-list') }, files.map(function (file, index) { return (react_1.default.createElement("li", { key: file.id },
                              react_1.default.createElement("div", { className: cx('FileControl-itemInfo', {
                                  ...
                                  file[urlField] ||
                                      file[valueField] ||
                                      downloadUrl ? (react_1.default.createElement("a", { className: cx('FileControl-itemInfoText'), target: "_blank", rel: "noopener", href: "#", onClick: _this.handleClickFile.bind(_this, file) }, file[nameField] ||
                                      file.filename)) : (react_1.default.createElement("span", { className: cx('FileControl-itemInfoText') }, file[nameField] ||
                                      file.filename)),
                                  file.state === 'invalid' ||
                                      file.state === 'error' ? (react_1.default.createElement(react_1.default.Fragment, null,
                                      react_1.default.createElement(icons_1.Icon, { icon: "fail", className: "icon" }),
                                      react_1.default.createElement("span", { className: "text-danger" }, file.error || null))) : null,
                                  !disabled ? (react_1.default.createElement("a", { "data-tooltip": __('Select.clear'), className: cx('FileControl-clear'), onClick: function () { return _this.removeFile(file, index); } },
