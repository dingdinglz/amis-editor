amis.define('node_modules/amis/lib/renderers/Form/InputCity', function(require, exports, module, define) {
  ...
  var CityPicker = /** @class */ (function (_super) {
      ...
      CityPicker.prototype.loadDb = function (callback) {
          ...
          Promise.resolve().then(function () { return new Promise(function(resolve){require(['node_modules/amis/lib/renderers/Form/CityDB'], function(ret) {resolve(tslib_1.__importStar(ret));})}); }).then(function (db) {
              _this.setState({
