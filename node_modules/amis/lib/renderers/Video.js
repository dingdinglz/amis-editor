amis.define('node_modules/amis/lib/renderers/Video', function(require, exports, module, define) {
  ...
  var video_react_1 = require("node_modules/video-react/lib/index");
  ...
  var FlvSource = /** @class */ (function (_super) {
      ...
      FlvSource.prototype.initFlv = function (_a) {
          ...
          Promise.resolve().then(function () { return new Promise(function(resolve){require(['node_modules/mpegts.js/dist/mpegts'], function(ret) {resolve(tslib_1.__importStar(ret));})}); }).then(function (mpegts) {
  ...
  var HlsSource = /** @class */ (function (_super) {
      ...
      HlsSource.prototype.initHls = function (_a) {
          ...
          // @ts-ignore
          Promise.resolve().then(function () { return new Promise(function(resolve){require(['node_modules/hls.js/dist/hls'], function(ret) {resolve(tslib_1.__importStar(ret));})}); }).then(function (_a) {
              var Hls = _a.default;
