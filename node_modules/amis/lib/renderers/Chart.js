amis.define('node_modules/amis/lib/renderers/Chart', function(require, exports, module, define) {
  ...
  var Chart = /** @class */ (function (_super) {
      ...
      Chart.prototype.refFn = function (ref) {
          ...
          if (ref) {
              Promise.all([
                  Promise.resolve().then(function () { return new Promise(function(resolve){require(['node_modules/echarts/dist/echarts'], function(ret) {resolve(tslib_1.__importStar(ret));})}); }),
                  Promise.resolve().then(function () { return new Promise(function(resolve){require(['node_modules/echarts-stat/index'], function(ret) {resolve(tslib_1.__importStar(ret));})}); }),
                  Promise.resolve().then(function () { return new Promise(function(resolve){require(['node_modules/echarts/extension/dataTool/index'], function(ret) {resolve(tslib_1.__importStar(ret));})}); }),
                  Promise.resolve().then(function () { return new Promise(function(resolve){require(['node_modules/echarts/extension/bmap/bmap'], function(ret) {resolve(tslib_1.__importStar(ret));})}); })
              ]).then(function (_a) {
      ...
      Chart.prototype.render = function () {
          ...
          return (react_1.default.createElement("div", { className: (0, classnames_1.default)(ns + "Chart", className), style: style },
              react_1.default.createElement(LazyComponent_1.default, { unMountOnHidden: unMountOnHidden, placeholder: "..." // 之前那个 spinner 会导致 sensor 失效
                  , component: function () { return (react_1.default.createElement("div", { className: ns + "Chart-content", ref: _this.refFn })); } })));
      };
      Chart.defaultProps = {
