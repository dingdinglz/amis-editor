amis.define('node_modules/amis/lib/renderers/Nav', function(require, exports, module, define) {
  ...
  var Navigation = /** @class */ (function (_super) {
      ...
      Navigation.prototype.renderItem = function (link, index, depth) {
          ...
          return (react_1.default.createElement("li", { key: link.__id, "data-id": link.__id, className: cx('Nav-item', link.className, {
              ...
              react_1.default.createElement(Badge_1.Badge, { classnames: cx, badge: itemBadge, data: (0, helper_1.createObject)(defaultData, link) },
                  react_1.default.createElement("a", { "data-id": link.__id, "data-depth": depth, onClick: this.handleClick.bind(this, link), style: { paddingLeft: depth * ((_a = parseInt(indentSize, 10)) !== null && _a !== void 0 ? _a : 24) } },
                      !disabled && draggable ? (react_1.default.createElement("div", { className: cx('Nav-itemDrager'), draggable: true, onMouseDown: function (e) { _this.toggleLink(link, true); e.stopPropagation(); } },
                  ...
                  // 更多操作
                  itemActions
                      ? react_1.default.createElement("div", { className: cx('Nav-item-atcions') }, render('inline', itemActions, { data: (0, helper_1.createObject)(defaultData, link) })) : null,
      ...
      Navigation.prototype.render = function () {
          ...
          return (react_1.default.createElement("div", { className: cx('Nav') },
              ...
              (dropIndicator
                  ? react_1.default.createElement("div", { className: cx('Nav-dropIndicator'), style: dropIndicator })
                  : null)));
      };
      var _a, _b, _c, _d;
