amis.define('node_modules/amis/lib/renderers/Table/ColumnToggler', function(require, exports, module, define) {
  ...
  var cloneDeep_1 = (0, tslib_1.__importDefault)(require("node_modules/lodash/cloneDeep"));
          ...
          return (react_1.default.createElement(react_1.default.Fragment, null,
              react_1.default.createElement(Modal_1.default, { closeOnEsc: true, onHide: this.close, show: this.state.isOpened, contentClassName: cx('ColumnToggler-modal'), container: modalContainer || this.target, overlay: typeof overlay === 'boolean' ? overlay : false },
                  ...
                  react_1.default.createElement("ul", { className: cx('ColumnToggler-modal-content'), ref: this.dragRef }, Array.isArray(tempColumns)
                      ? tempColumns.map(function (column, index) { return (react_1.default.createElement(TooltipWrapper_1.default, { tooltipClassName: cx('ColumnToggler-tooltip'), placement: "top", tooltip: column.label || '', trigger: enableSorting ? 'click' : 'hover', key: column.index },
                          react_1.default.createElement("li", { className: cx('ColumnToggler-menuItem'), key: column.index }, enableSorting && draggable && tempColumns.length > 1 ? (react_1.default.createElement(react_1.default.Fragment, null,
                              ...
                              react_1.default.createElement("span", null, column.label ? render('tpl', column.label) : null))) : (react_1.default.createElement(Checkbox_1.default, { size: "sm", classPrefix: ns, checked: column.toggled, disabled: !column.toggable || enableSorting, onChange: _this.updateToggledColumn.bind(_this, column, index) },
                              react_1.default.createElement("span", null, column.label ? render('tpl', column.label) : null)))))); })
                      : null),
                  react_1.default.createElement("footer", { className: cx('ColumnToggler-modal-footer') },
                      ...
                      react_1.default.createElement("div", null,
                          react_1.default.createElement(Button_1.default, { className: "mr-4", onClick: this.close }, __('cancel')),
