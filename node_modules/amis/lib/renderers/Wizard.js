amis.define('node_modules/amis/lib/renderers/Wizard', function(require, exports, module, define) {
          ...
          if (this.state.currentStep < steps.length) {
              ...
              if (target) {
                  ...
                  formStore
                      ...
                      .then(function (value) {
                      _this.setState({ completeStep: steps.length });
      ...
      Wizard.prototype.renderWizard = function () {
          ...
          return (react_1.default.createElement("div", { ref: this.domRef, className: cx(ns + "Panel " + ns + "Panel--default " + ns + "Wizard " + ns + "Wizard--" + mode, className) },
              react_1.default.createElement("div", { className: ns + "Wizard-step" },
                  this.renderSteps(),
                  react_1.default.createElement("div", { role: "wizard-body", className: ns + "Wizard-stepContent clearfix" }, step ? (render('body', (0, tslib_1.__assign)((0, tslib_1.__assign)({}, step), { type: 'form', wrapWithPanel: false, 
                      // 接口相关需要外部来接管
                      api: null }), {
