amis.define('node_modules/amis/lib/renderers/Operation', function(require, exports, module, define) {
      ...
      OperationField.prototype.render = function () {
          ...
          return (react_1.default.createElement("div", { className: cx('OperationField', className) }, Array.isArray(buttons)
              ? buttons.map(function (button, index) {
                  return render("" + index, (0, tslib_1.__assign)({ type: 'button', size: button.size || 'sm', level: button.level ||
