amis.define('node_modules/amis/lib/store/formItem', function(require, exports, module, define) {
  ...
  var validations_1 = require("node_modules/amis/lib/utils/validations");
  ...
  var helper_2 = require("node_modules/amis/lib/utils/helper");
  ...
  var node_1 = require("node_modules/amis/lib/store/node");
  ...
  exports.FormItemStore = node_1.StoreNode.named('FormItemStore')
      ...
      var deferLoadOptions = (0, mobx_state_tree_1.flow)(function getInitData(option, api, data, config) {
