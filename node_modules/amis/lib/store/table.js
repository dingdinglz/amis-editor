amis.define('node_modules/amis/lib/store/table', function(require, exports, module, define) {
  ...
  exports.TableStore = iRenderer_1.iRendererStore
      ...
      function update(config) {
          ...
          if (config.columns && Array.isArray(config.columns)) {
              ...
              columns = columns.map(function (item, index) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, item), { index: index, rawIndex: index - 3, type: item.type || 'plain', pristine: item, toggled: item.toggled !== false, breakpoint: item.breakpoint, isPrimary: index === 3 })); });
