amis.define('node_modules/amis/lib/utils/helper', function(require, exports, module, define) {
  ...
  function hasAbility(schema, ability, data, defaultValue) {
      ...
      return schema.hasOwnProperty(ability)
          ...
          : schema.hasOwnProperty(ability + "On")
              ? (0, tpl_1.evalExpression)(schema[ability + "On"], data || schema)
              : defaultValue;
  }
  ...
  function loadScript(src) {
      return new Promise(function (ok, fail) {
          ...
          if (~src.indexOf('{{callback}}')) {
              var callbackFn_1 = "loadscriptcallback_" + (0, exports.uuid)();
  ...
  function resolveValueByName(data, name) {
      return (0, tpl_builtin_1.isPureVariable)(name)
          ? (0, tpl_builtin_1.resolveVariableAndFilter)(name, data)
          : (0, tpl_builtin_1.resolveVariable)(name, data);
  }
  // 统一的获取 value 值方法
