amis.define('node_modules/echarts/extension/bmap/BMapCoordSys', function(require, exports, module, define) {
  ...
  */
  // @ts-nocheck
  /* global BMap */
  var echarts_1 = require("node_modules/echarts/dist/echarts");
  ...
  BMapCoordSys.create = function (ecModel, api) {
      ...
      ecModel.eachComponent('bmap', function (bmapModel) {
          ...
          if (!bmapModel.__bmap) {
              ...
              if (mapOptions) {
                  mapOptions = echarts_1.util.clone(mapOptions); // Not support `mapType`, use `bmap.setMapType(MapType)` instead.
  ...
  //# sourceMappingURL=/node_modules/echarts/extension/bmap/BMapCoordSys.js.map
