amis.define('node_modules/qrcode.react/lib/index', function(require, exports, module, define) {
  ...
  var PropTypes = require('node_modules/prop-types/index'); // qr.js doesn't handle error level of zero (M) so we need to do it right,
  // thus the deep require.
  
  
  var QRCodeImpl = require('node_modules/qr.js/lib/QRCode');
  
  var ErrorCorrectLevel = require('node_modules/qr.js/lib/ErrorCorrectLevel'); // TODO: pull this off of the QRCode class type so it matches.
