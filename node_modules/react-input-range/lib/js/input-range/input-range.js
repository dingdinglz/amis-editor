amis.define('node_modules/react-input-range/lib/js/input-range/input-range', function(require, exports, module, define) {
  ...
  var _autobindDecorator = require('node_modules/autobind-decorator/lib/index');
  
  var _autobindDecorator2 = _interopRequireDefault(_autobindDecorator);
  
  var _valueTransformer = require('node_modules/react-input-range/lib/js/input-range/value-transformer');
  
  var valueTransformer = _interopRequireWildcard(_valueTransformer);
  
  var _defaultClassNames = require('node_modules/react-input-range/lib/js/input-range/default-class-names');
  
  var _defaultClassNames2 = _interopRequireDefault(_defaultClassNames);
  
  var _label = require('node_modules/react-input-range/lib/js/input-range/label');
  
  var _label2 = _interopRequireDefault(_label);
  
  var _rangePropType = require('node_modules/react-input-range/lib/js/input-range/range-prop-type');
  
  var _rangePropType2 = _interopRequireDefault(_rangePropType);
  
  var _valuePropType = require('node_modules/react-input-range/lib/js/input-range/value-prop-type');
  
  var _valuePropType2 = _interopRequireDefault(_valuePropType);
  
  var _slider = require('node_modules/react-input-range/lib/js/input-range/slider');
  
  var _slider2 = _interopRequireDefault(_slider);
  
  var _track = require('node_modules/react-input-range/lib/js/input-range/track');
  
  var _track2 = _interopRequireDefault(_track);
  
  var _utils = require('node_modules/react-input-range/lib/js/utils/index');
  
  var _keyCodes = require('node_modules/react-input-range/lib/js/input-range/key-codes');
  ...
  //# sourceMappingURL=/node_modules/react-input-range/lib/js/input-range/input-range.js.map
