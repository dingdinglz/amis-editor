amis.define('node_modules/mobx-state-tree/dist/mobx-state-tree', function(require, exports, module, define) {
  ...
  */
  ...
  function isTypeCheckingEnabled() {
      return (devMode() ||
          ("undefined" !== "undefined" && process.env && process.env.ENABLE_TYPE_CHECK === "true"));
  }
  /**
   * @internal
   * @hidden
